...
Ahhoz, hogy a programozók eljárásokat tudjanak írni a programok írása során, különféle utasításokra van szükségük. Ezek az utasítások a Game Boy architektúrájában az ugrás (\mintinline{asm}{JP}), az eljáráshívás (\mintinline{asm}{CALL}) és a visszatérés (\mintinline{asm}{RET}).

\newpage
\subsection{Verem utasítások - \texttt{PUSH, POP}}
\subsection{\textit{Rotate} és \textit{Shift} - \texttt{RLC, RRC, RL, RR, SLA, SRA, SRL}}
\subsection{Bitmanipulációs utasítások - \texttt{BIT, RES, SET}}

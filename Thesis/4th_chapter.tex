...
\begin{itemize}
  ...
  \item \textbf{5. bit:} ez a bit az X flip bit, ha az értéke 1, akkor az aktuális \textit{sprite} X tengely menti tükörképe fog menjelenni a kijelzõn. Ezzel lehetséges a karakter \textit{sprite}-ját mindig a menetiránnyal megegyezõ irányban kirajzolni.

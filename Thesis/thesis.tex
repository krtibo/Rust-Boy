...
\begin{itemize}
  ...
  A feladat egy Nintendo Game Boy emulátor implementálása, és fejlesztési fá\-zi\-sa\-i\-nak bemutatása. A bemutatás során a CPU utasításait, a GPU renderelésének mûködését, a memóriakezelést, és a megszakítás-vezérlést kell érinteni, illetve az egyéb kisebb, de a mûködéshez elengedhetetlen megoldások is megemlítésre kerül\-nek. Ahhoz, hogy ezek megfelelõen mûködjenek, a CPU frekvenciájára, illetve a képfrissítési gyakoriságra is tekintettel kell lenni.

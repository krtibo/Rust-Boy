...
Fontos még megemlíteni, hogy a \textit{Stack Overflow} weboldalon megrendezett éves fejlesztõi kérdõív kitöltések alapján 2016-ban, 2017-ben és 2018-ban is a Rust nyerte a ``leginkább kedvelt programozási nyelv'' kategóriát \cite{So}. Egyéb érdekesség, hogy jól megfigyelhetõ, hogy az emulátor fejlesztõ közösség túlnyomó többsége  \texttt{C++}-ban, vagy Rust-ban fejleszt -- ez a nyelv kényelmességének, eleganciájának és sokoldalúságának is köszönhetõ. \\

...
\noindent Egy emulátor fejlesztési folyamatának bemutatására a Nintendo Game Boy tökéletes példa több szempontból is. Elsõsorban széleskörûen ismert, ebbõl adódóan az emulátor fejlesztõi közösség által is jól dokumentált, a hardver szinte az utolsó részletig vissza lett fejtve. Ezek a dokumentációk tehát jó kiindulási alapot nyújtanak. Az is fontos szempont, hogy a hardver a 8 bites érából származik, ami szinte garantálja az egyszerûbb architektúrát (ez persze relatív), így a könnyebb implementálhatóságot is. Szintén meg\-em\-lí\-ten\-dõ, hogy a közösség által készített teszt ROM-ok nagyban segítik a hibakeresést, verifikációt.
...
\begin{itemize}
  ...
  \item \textbf{Hang}: 2 négyszögjel generátor, 1 programozható 32 mintás 4 bites PCM hullám, 1 fehér zaj, és egy audio bemenet a kazettából. (A külsõ kazetta bemenetet egy piacra dobott játék sem használta.) A \textit{jack} kimeneten keresztül sztereó hangot ad.
...
\begin{figure}[h!]%
    \centering
    \subfloat[\textit{A Sharp LR35902 CPU}]{{\includegraphics[height=5.5cm]{./Resources/v2/eps/CPUcloseup.eps} }}%
    \qquad

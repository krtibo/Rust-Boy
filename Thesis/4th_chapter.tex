...
\begin{table}[h!]
  ...
  \begin{tabu}{|>{\columncolor{GameBoyBlue}}l|[2pt]c|c|} 
   \hline
  \textbf{Esemény} & \cellcolor{GameBoyBlue} \textbf{PPU mód azonosító} & \cellcolor{GameBoyBlue} \textbf{Igénybevett idõ} \\ \tabucline[2pt]{-}
